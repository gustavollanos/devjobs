<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-200 mt-6">
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1 mb-5">
                        ...
                        <div class="mb-5 mt-0">
                            <a class="bg-indigo-600 p-2 text-sm uppercase font-bold text-white rounded-lg block text-center"
                                href="{{ route('vacantes.show', $vacante->id) }}">
                                ver Vacante
                            </a>
                        </div>
